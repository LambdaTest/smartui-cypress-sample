...
<p align="center">
  ...
  <a href="https://www.testmuai.com/smart-ui-testing/"><img src="https://img.shields.io/badge/-cypress-%23E5E5E5?style=for-the-badge&logo=cypress&logoColor=058a5e" alt="Cypress SmartUI"></a>
...
With TestMu AI (Formerly LambdaTest), you can run SmartUI Cypress visual regression tests across real browsers and operating systems. This sample shows how to configure Cypress SmartUI tests to run on the TestMu AI cloud for automated visual testing.
...
Execute the Cypress SmartUI test using the configuration file `lambdatest-smartUI-config.json`:
...
Add the tunnel configuration in `lambdatest-smartUI-config.json`:
